    ...
    methods: {
        loadVideo() {
            ...
            this.manifestUrl.forEach((e, i) => {
                ...
                player
                    .load(
                        `https://${base_url}:3000/stream/${e.replace(
                            ".mpd",
                            ""
                        )}/${e}`
                    )
                    .then(() => {
                        ...
                        player.g.addEventListener("ended", () => {
                            ...
                            // 영상 재생
                            this.$refs[
                                "videoPlayer" + this.currentPlayerNumber
                            ][0].play();
                        });
                    })
                    .catch(err => {
        ...
        moveVideoTime(val) {
            ...
            this.manifestUrl.forEach((e, i) => {
                if (i === videoIndex) {
                    ...
                    this.currentTime =
                        diff.hours() * 60 * 60 + diff.minutes() * 60;
                    ...
                    console.log(
                        this.$refs["videoPlayer" + videoIndex][0].duration,
                        seconds
                    );
                    ...
                    let scala =
                        ...
                        this.totalVideoTime;
                    this.$refs.timeline__progress.style.transform =
                        "scaleX(" + scala + ")";

                    this.$refs["videoContainer" + videoIndex][0].style.display =
                        "block";
